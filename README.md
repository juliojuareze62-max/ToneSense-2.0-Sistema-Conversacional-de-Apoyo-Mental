...
- Estilo reflexivo  
- Nivel de seguridad/inseguridad  
- Fluidez y coherencia verbal  
- Velocidad de procesamiento

Este proyecto forma parte del **remedial**, representando un cambio significativo en el núcleo, metodología y propósito del sistema.
...
- Modelo híbrido: CNN + análisis estadístico de voz  
- Clasificación en estilos cognitivos  
